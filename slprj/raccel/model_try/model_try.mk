...
MODEL                   = model_try
MODULES                 = model_try.c model_try_capi.c model_try_data.c model_try_tgtconn.c rtGetInf.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = model_try
MAKEFILE                = model_try.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2025b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2025b
START_DIR               = /home/velo/Documentos/Fac/5ano/SCDTR/projeto
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 2
COMPUTER                = GLNXA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/model_try \
